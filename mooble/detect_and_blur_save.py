...
def detect(save_img=False):
    source, weights, view_img, save_txt, imgsz, trace, blurratio,hidedetarea = opt.source, opt.weights, opt.view_img, opt.save_txt, opt.img_size, not opt.no_trace, 50 ,opt.hidedetarea,
    blurratio_0 = 1
                ...
                if dataset.mode == 'image':
                    ...
                    if vid_path != save_path:  # new video
                        ...
                        if vid_cap:  # video
                            ...
                            fps, w, h = 90, im0.shape[1], im0.shape[0]
                            save_path += '.mp4'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='project.pt', help='model.pt path(s)')
    ...
    parser.add_argument('--blurratio',type=int,default=50, required=True, help='blur opacity')
