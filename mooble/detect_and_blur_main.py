...
def detect(weights='project.pt', source='0', img_size=640, conf_thres=0.25, iou_thres=0.45, device='0', view_img=True,
           save_txt=False, save_conf=False, nosave=False, classes=None, agnostic_nms=False, augment=False,
           update=False, project='runs/detect', name='exp', exist_ok=False, no_trace=False, blurratio=50, hidedetarea=False):
